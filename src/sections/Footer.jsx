    ...
    <footer className='max-container' id='about-us'>
      <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          ...
          <p className='mt-6 text-base leading-7 font-montserrat text-coral-red-400 sm:max-w-sm'>
          ...
          <div className='flex items-center gap-5 mt-8'>
            {socialMedia.map((icon) => (
              <div
                className='flex justify-center items-center w-12 h-12 bg-coral-red rounded-full'
                key={icon.alt}
              >
